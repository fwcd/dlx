...
export const OPCODES: { [code: string]: Instruction; } = {
	...
	"SGT": new RegisterInstruction((a, b) => (a > b) ? 1 : 0),
	"SGTI": new ImmediateInstruction((a, b) => (a > b) ? 1 : 0),
	"SGE": new RegisterInstruction((a, b) => (a >= b) ? 1 : 0),
	"SGEI": new ImmediateInstruction((a, b) => (a >= b) ? 1 : 0),
